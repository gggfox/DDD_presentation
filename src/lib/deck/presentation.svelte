<script lang="ts">
	...
	import StrategicDesign from './presentation/StrategicDesign.svelte';
</script>

<Slide>
	<p class="capitalize">Domain Driven Design 🧱</p>
</Slide>

<Slide>
	<p class="capitalize italic text-2xl">
...
<Slide>
	<Slide>
		<p class="capitalize">Tactical Design 🔫</p>
	</Slide>
	<Slide>
...
<Slide id="animate" animate>
	<p class="capitalize">??? 🦄</p>
	<p class="capitalize">Heuristics</p>
</Slide>

<Slide id="animate" animate>
	<p class="capitalize">??? 🦄</p>
	<p class="capitalize">Heuristics</p>
	<p class="capitalize">Evolving Design Decisions</p>
</Slide>
...
<Slide id="animate" animate>
	...
	<p class="capitalize">Heuristics</p>
	<p class="capitalize">Evolving Design Decisions</p>
	<p class="capitalize">Event Storming</p>
</Slide>
<Slide id="animate" animate>
	<p class="capitalize">??? 🦄</p>
	<p class="capitalize">Heuristics</p>
	<p class="capitalize">Evolving Design Decisions</p>
	<p class="capitalize">Event Storming</p>
	<p class="capitalize">Domain Driven Design in the real world</p>
</Slide>
...
<Slide id="boxes" animate>
	<p>Moving boxes</p>
	<div class="flex gap-2 place-content-center">
		<div data-id="box-1" class="w-[200px] h-[200px] bg-gray-400" />
		<img src="https://i.giphy.com/media/ToMjGpnXBTw7vnokxhu/giphy.webp" alt="Whoa" />
		<div data-id="box-3" class="w-[200px] h-[200px] bg-gray-400" />
	</div>
	<p>Whoa!</p>
</Slide>
